    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day', models.CharField(choices=[    ('Lunes', 'Lunes'),('Martes', 'Martes'),('Miercoles', 'Miercoles'),('Jueves', 'Jueves'),('Viernes', 'Viernes'),('Sábado', 'Sábado'),], default='Lunes', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Trabajos Independientes', 'Trabajos Independientes'), ('Quiz', 'Quiz'), ('Autoevaluación', 'Autoevaluación'), ('Parcial', 'Parcial')], default='Trabajos Independientes', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200)),
                ('sex', models.CharField(choices=[    ('Femenino', 'Femenino'),('Masculino', 'Masculino')], default='Male', max_length=50)),
