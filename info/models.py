...
test_name = (
    ('Trabajos Independientes', 'Trabajos Independientes'),
    ('Quiz', 'Quiz'),
...
class Marks(models.Model):
    ...
    name = models.CharField(max_length=50, choices=test_name, default='Trabajos Independientes')
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='Trabajos Independientes')
                    sc.marks_set.create(name='Quiz')
                    sc.marks_set.create(name='Autoevaluación')
                    sc.marks_set.create(name='Parcial')
