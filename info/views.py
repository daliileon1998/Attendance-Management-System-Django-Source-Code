...
def marks_list(request, stud_id):
    ...
    for ass in ass_list:
        try:
            ...
            sc.save()
            sc.marks_set.create(type='I', name='Trabajos Independientes')
            sc.marks_set.create(type='I', name='Quiz')
            sc.marks_set.create(type='I', name='Autoevaluación')
            sc.marks_set.create(type='E', name='Parcial')
        sc_list.append(sc)
